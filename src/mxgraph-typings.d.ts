// Type definitions based on https://github.com/lgleim/mxgraph-typings
...
export module mxgraph {
    ...
    export class mxGraph extends mxEventSource {
         ...
         */
        tapAndHold(me: any, state?: any): void;
        /**
         ...
         */
        center(horizontal?: boolean, vertical?: boolean, cx?: any, cy?: any): void;
        /**
         ...
         */
        getDropTarget(cells: any, evt: any, cell: any, clone?: boolean): any;
        /**
        ...
        getCellAt(
            ...
            vertices?: boolean,
            edges?: boolean,
            ignoreFn?: (cell: mxCellState, x: number, y: number) => boolean,
        ): any;
        /**
         * Returns the bottom-most cell that intersects the given point (x, y) in
         ...
         */
        findTreeRoots(parent: any, isolate?: boolean, invert?: boolean): any[];
        /**
         * Traverses the (directed) graph invoking the given function for each
         * visited vertex and edge. The function is invoked with the current vertex
         * and the incoming edge as a parameter. This implementation makes sure
         ...
         */
        traverse(vertex: any, directed: any, func: any, edge?: any, visited?: any, inverse?: boolean): void;
        /**
    ...
    export class mxDefaultKeyHandler {
         ...
         * Default is false.
         */
        bindAction(code: any, action: any, control?: boolean): void;
        /**
    ...
    export class mxDefaultToolbar {
         ...
         */
        insert(vertex: any, evt: any, parent?: any): any;
        /**
    ...
    export class mxEditor extends mxEventSource {
         ...
         */
        treeLayout(cell: any, horizontal?: boolean): void;
        /**
